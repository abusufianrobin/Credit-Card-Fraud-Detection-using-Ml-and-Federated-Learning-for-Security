...
st.write("Enter the following information to check for fraud: ")
...
if st.button("Check For Fraud"):
  if merchant and category and cc_num:
    ...
    result = "Fraudulant Transaction" if prediction ==1 else "Non-Fraudulent Transaction"
...
st.write("Developed by Abu Sufian Robin")